            ...
            <div class="col-md-12">
                <div class="card shadow mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        ...
                        <a href="{{ route('frontend.ticket.show', $ticket->uid) }}" class="btn btn-sm btn-info">
                            <i class="fas fa-eye mr-1"></i> View Ticket
                        </a>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('frontend.ticket.update', $ticket->uid) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
